...
var social_links = {
    ...
    options: {
        icons: [
            {
                icon: '/assets/template/webform/image/vk.png',
                title: 'Вконтакте',
                link: 'https://vk.com/raspisanievuzov'
            },
            {
                icon: '/assets/template/webform/image/facebook.png',
                title: 'Facebook',
                link: 'https://www.facebook.com/vuzarium'
            },
            {
                icon: '/assets/template/webform/image/twitter.png',
                title: 'Twitter',
                link: 'https://twitter.com/raspisanievuzov'
            },
            {
                icon: '/assets/template/webform/image/habrahabr.png',
                title: 'ХабраХабр',
